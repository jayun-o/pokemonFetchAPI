...
function App() {
  ...
  useEffect(() => {
    ...
    let abortController = new AbortController(); //cancel req (call again)
  ...
  return (
    ...
    <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2'>
      ...
      <div>
        ...
        {fav.lenght > 0 ? <FavPoke fav={fav}/> : <div className='flex h-full justify-center items-center'><p> No favorite pokemon...</p></div>}
      </div>
    </div>
    </div>
  )
